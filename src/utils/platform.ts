...
export class PlatformManager {
  ...
  private tabs: Record<SocialMediaPlatform, HTMLElement> = {} as Record<
    SocialMediaPlatform,
    HTMLElement
  >;
  private contents: Record<SocialMediaPlatform, HTMLElement> = {} as Record<
    SocialMediaPlatform,
    HTMLElement
  >;
  private results: Record<SocialMediaPlatform, HTMLElement> = {} as Record<
    SocialMediaPlatform,
    HTMLElement
  >;
  private spinners: Record<SocialMediaPlatform, HTMLElement> = {} as Record<
    SocialMediaPlatform,
    HTMLElement
  >;
