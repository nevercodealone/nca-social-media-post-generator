...
import { validateTranscript, validateVideoDuration, validateKeywords, sanitizeApiKey } from '../../src/utils/validation.js';
...
describe('Validation Utilities', () => {
  describe('validateTranscript', () => {
    ...
    it('should handle whitespace-only transcripts', () => {
      ...
      expect(validateTranscript(whitespaceTranscript)).toBe('Bitte gib ein gültiges Transkript ein.');
    });
